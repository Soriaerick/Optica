...
* **Rediseño de Navegación:** El menú lateral por un menú superior estático (`sticky`) para modernizar la interfaz y aprovechar el ancho de la pantalla.
...
* En este apartado se tuvo atrasos en la semana.

## Notas Técnicas y Curva de Aprendizaje
Este Segundo Sprint no solo consistió en escribir más código, sino que tambien se tuvo que volver a implementar nuevamente Docker :
...
## Próximos Pasos (Para el Sprint 3)
